...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(train_loader_80):
            ...
            if i % 500 == 499:
                ...
                if val_accuracy_phase > best_val_accuracy_phase:
                    ...
                    torch.save(model.module.state_dict(),"./best_model/non-local/pretrained_lr5e-7_L40_2fc_copy/" + public_name + ".pth")
        ...
        torch.save(model.module.state_dict(), "./temp/non-local/pretrained_lr5e-7_L40_2fc_copy/latest_model_"+str(epoch)+".pth")
